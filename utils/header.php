    ...
    <nav class="navbar" >
        ...
        <div class="navbar-header"><!--website name/title-->
                ...
                <a class = "navbar-brand">
                    <h2> <strong> RIT CULTURAL EVENT SYSTEM </strong> </h2>
                </a>
        </div>
    ...
    <div class = "col-md-12">
        <div class = "container">
            <div class = "jumbotron"><!--jumbotron-->
                <h1>LET'S DO LOGIN!!!<br></h1><!--jumbotron heading-->
                <h2>WELCOME TO RIT<br></h2>

                <h1><strong> Information Science & Engineering</strong><h1>
